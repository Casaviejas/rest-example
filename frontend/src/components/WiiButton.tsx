...
export const WiiButton = forwardRef<HTMLButtonElement, WiiButtonProps>(
  ({ variant = "primary", children, className = "", ...props }, ref) => {
    const variantStyles = {
      primary:
        "bg-[#1F88E8] hover:bg-[#1F88E8]/90 border-[#00D9FF] shadow-[0_0_20px_rgba(0,217,255,0.3)]",
      secondary:
        "bg-[#B0B8C1] hover:bg-[#B0B8C1]/90 border-[#B0B8C1] shadow-[0_0_20px_rgba(176,184,193,0.3)]",
      danger:
        "bg-[#FF6B35] hover:bg-[#FF6B35]/90 border-[#FF6B35] shadow-[0_0_20px_rgba(255,107,53,0.3)]",
    };
